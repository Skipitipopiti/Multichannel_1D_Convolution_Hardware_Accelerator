...
vlog -work ./work ../netlist/filter_core_pipe_10Tadd_half_fmax_ckg.v
vlog -sv -work ./work ../tb/tb_fir_pipe_10Tadd.sv

vsim -L /eda/dk/nangate45/verilog/qsim2020.4 work.tb_fir_pipe_10Tadd
vsim -t ps -L /eda/dk/nangate45/verilog/qsim2020.4 -sdftyp /tb_fir_pipe_10Tadd/UUT=../netlist/filter_core_pipe_10Tadd_half_fmax_ckg.sdf work.tb_fir_pipe_10Tadd

vcd file ../vcd/filter_core_pipe_10Tadd_half_fmax_ckg_syn.vcd
