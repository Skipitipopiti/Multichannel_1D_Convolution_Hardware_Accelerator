...
module filter_core ( clk, DIN, b0, b1, b2, b3, b4, b5, b6, b7, b8, b9, b10, a0, 
  ...
  wire   v_o, z_10__8_, z_10__7_, z_10__6_, z_10__5_, z_10__4_, z_10__3_,
         ...
         y_tmp_0__10_, DIN_REG_net167, VIN_REG_n3, VIN_REG_n2, VIN_REG_n1,
         REG_0_net167, REG_1_net167, REG_2_net167, REG_3_net167, REG_4_net167,
         REG_5_net167, REG_6_net167, REG_7_net167, REG_8_net167, REG_9_net167,
         REG_10_net167, REG_0_0_net167, REG_1_0_net167, REG_2_0_net167,
         REG_3_0_net167, REG_4_0_net167, REG_5_0_net167, REG_6_0_net167,
         REG_7_0_net167, REG_8_0_net167, REG_9_0_net167, DOUT_REG_net167,
         VOUT_REG_n6, VOUT_REG_n5, VOUT_REG_n4, mult_114_n366, mult_114_n365,
         ...
         mult_114_n76, mult_114_n75, mult_114_n74, mult_114_n73, mult_114_n72,
         mult_114_n71, mult_114_n70, mult_114_n69, mult_114_n68, mult_114_n67,
         mult_114_n66, mult_114_n65, mult_114_n64, mult_114_n63, mult_114_n62,
         mult_114_n61, mult_114_n60, mult_114_n59, mult_114_n58, mult_114_n57,
         mult_114_n56, mult_114_n55, mult_114_n54, mult_114_n53, mult_114_n52,
         mult_114_n51, mult_114_n50, mult_114_n49, mult_114_n48, mult_114_n47,
         mult_114_n45, mult_114_n44, mult_114_n43, mult_114_n42, mult_114_n41,
         mult_114_n40, mult_114_n39, mult_114_n38, mult_114_n37, mult_114_n36,
         mult_114_n35, mult_114_n34, mult_114_n33, mult_114_n31, mult_114_n30,
         mult_114_n29, mult_114_n28, mult_114_n27, mult_114_n26, mult_114_n25,
         mult_114_n24, mult_114_n23, mult_114_n21, mult_114_n20, mult_114_n19,
         mult_114_n18, mult_114_n9, mult_114_n8, mult_114_n7, mult_114_n6,
         mult_114_n5, mult_114_n4, mult_114_n3, mult_114_n2, mult_114_G2_n366,
  ...
  SNPS_CLOCK_GATE_HIGH_regn_s_N9_0 DIN_REG_clk_gate_Q_reg ( .CLK(clk), .EN(
        1'b1), .ENCLK(DIN_REG_net167), .TE(1'b0) );
  DFFR_X1 DIN_REG_Q_reg_0_ ( .D(DIN[0]), .CK(DIN_REG_net167), .RN(RST_n), .Q(
        x[90]) );
  DFFR_X1 DIN_REG_Q_reg_1_ ( .D(DIN[1]), .CK(DIN_REG_net167), .RN(RST_n), .Q(
        x[91]) );
  DFFR_X1 DIN_REG_Q_reg_2_ ( .D(DIN[2]), .CK(DIN_REG_net167), .RN(RST_n), .Q(
        x[92]) );
  DFFR_X1 DIN_REG_Q_reg_3_ ( .D(DIN[3]), .CK(DIN_REG_net167), .RN(RST_n), .Q(
        x[93]) );
  DFFR_X1 DIN_REG_Q_reg_4_ ( .D(DIN[4]), .CK(DIN_REG_net167), .RN(RST_n), .Q(
        x[94]) );
  DFFR_X1 DIN_REG_Q_reg_5_ ( .D(DIN[5]), .CK(DIN_REG_net167), .RN(RST_n), .Q(
        x[95]) );
  DFFR_X1 DIN_REG_Q_reg_6_ ( .D(DIN[6]), .CK(DIN_REG_net167), .RN(RST_n), .Q(
        x[96]) );
  DFFR_X1 DIN_REG_Q_reg_7_ ( .D(DIN[7]), .CK(DIN_REG_net167), .RN(RST_n), .Q(
        x[97]) );
  DFFR_X1 DIN_REG_Q_reg_8_ ( .D(DIN[8]), .CK(DIN_REG_net167), .RN(RST_n), .Q(
        x[98]) );
  ...
  DFFR_X1 VIN_REG_Q_reg ( .D(VIN_REG_n3), .CK(clk), .RN(RST_n), .Q(v_o), .QN(
        VIN_REG_n2) );
  SNPS_CLOCK_GATE_HIGH_regn_s_N9_22 REG_0_clk_gate_Q_reg ( .CLK(clk), .EN(1'b1), .ENCLK(REG_0_net167), .TE(1'b0) );
  DFFR_X1 REG_0_Q_reg_0_ ( .D(b0[0]), .CK(REG_0_net167), .RN(RST_n), .Q(bi[90]) );
  DFFR_X1 REG_0_Q_reg_1_ ( .D(b0[1]), .CK(REG_0_net167), .RN(RST_n), .Q(bi[91]) );
  DFFR_X1 REG_0_Q_reg_2_ ( .D(b0[2]), .CK(REG_0_net167), .RN(RST_n), .Q(bi[92]) );
  DFFR_X1 REG_0_Q_reg_3_ ( .D(b0[3]), .CK(REG_0_net167), .RN(RST_n), .Q(bi[93]) );
  DFFR_X1 REG_0_Q_reg_4_ ( .D(b0[4]), .CK(REG_0_net167), .RN(RST_n), .Q(bi[94]) );
  DFFR_X1 REG_0_Q_reg_5_ ( .D(b0[5]), .CK(REG_0_net167), .RN(RST_n), .Q(bi[95]) );
  DFFR_X1 REG_0_Q_reg_6_ ( .D(b0[6]), .CK(REG_0_net167), .RN(RST_n), .Q(bi[96]) );
  DFFR_X1 REG_0_Q_reg_7_ ( .D(b0[7]), .CK(REG_0_net167), .RN(RST_n), .Q(bi[97]) );
  DFFR_X1 REG_0_Q_reg_8_ ( .D(b0[8]), .CK(REG_0_net167), .RN(RST_n), .Q(bi[98]) );
  SNPS_CLOCK_GATE_HIGH_regn_s_N9_21 REG_1_clk_gate_Q_reg ( .CLK(clk), .EN(1'b1), .ENCLK(REG_1_net167), .TE(1'b0) );
  DFFR_X1 REG_1_Q_reg_0_ ( .D(b1[0]), .CK(REG_1_net167), .RN(RST_n), .Q(bi[81]) );
  DFFR_X1 REG_1_Q_reg_1_ ( .D(b1[1]), .CK(REG_1_net167), .RN(RST_n), .Q(bi[82]) );
  DFFR_X1 REG_1_Q_reg_2_ ( .D(b1[2]), .CK(REG_1_net167), .RN(RST_n), .Q(bi[83]) );
  DFFR_X1 REG_1_Q_reg_3_ ( .D(b1[3]), .CK(REG_1_net167), .RN(RST_n), .Q(bi[84]) );
  DFFR_X1 REG_1_Q_reg_4_ ( .D(b1[4]), .CK(REG_1_net167), .RN(RST_n), .Q(bi[85]) );
  DFFR_X1 REG_1_Q_reg_5_ ( .D(b1[5]), .CK(REG_1_net167), .RN(RST_n), .Q(bi[86]) );
  DFFR_X1 REG_1_Q_reg_6_ ( .D(b1[6]), .CK(REG_1_net167), .RN(RST_n), .Q(bi[87]) );
  DFFR_X1 REG_1_Q_reg_7_ ( .D(b1[7]), .CK(REG_1_net167), .RN(RST_n), .Q(bi[88]) );
  DFFR_X1 REG_1_Q_reg_8_ ( .D(b1[8]), .CK(REG_1_net167), .RN(RST_n), .Q(bi[89]) );
  SNPS_CLOCK_GATE_HIGH_regn_s_N9_20 REG_2_clk_gate_Q_reg ( .CLK(clk), .EN(1'b1), .ENCLK(REG_2_net167), .TE(1'b0) );
  DFFR_X1 REG_2_Q_reg_0_ ( .D(b2[0]), .CK(REG_2_net167), .RN(RST_n), .Q(bi[72]) );
  DFFR_X1 REG_2_Q_reg_1_ ( .D(b2[1]), .CK(REG_2_net167), .RN(RST_n), .Q(bi[73]) );
  DFFR_X1 REG_2_Q_reg_2_ ( .D(b2[2]), .CK(REG_2_net167), .RN(RST_n), .Q(bi[74]) );
  DFFR_X1 REG_2_Q_reg_3_ ( .D(b2[3]), .CK(REG_2_net167), .RN(RST_n), .Q(bi[75]) );
  DFFR_X1 REG_2_Q_reg_4_ ( .D(b2[4]), .CK(REG_2_net167), .RN(RST_n), .Q(bi[76]) );
  DFFR_X1 REG_2_Q_reg_5_ ( .D(b2[5]), .CK(REG_2_net167), .RN(RST_n), .Q(bi[77]) );
  DFFR_X1 REG_2_Q_reg_6_ ( .D(b2[6]), .CK(REG_2_net167), .RN(RST_n), .Q(bi[78]) );
  DFFR_X1 REG_2_Q_reg_7_ ( .D(b2[7]), .CK(REG_2_net167), .RN(RST_n), .Q(bi[79]) );
  DFFR_X1 REG_2_Q_reg_8_ ( .D(b2[8]), .CK(REG_2_net167), .RN(RST_n), .Q(bi[80]) );
  SNPS_CLOCK_GATE_HIGH_regn_s_N9_19 REG_3_clk_gate_Q_reg ( .CLK(clk), .EN(1'b1), .ENCLK(REG_3_net167), .TE(1'b0) );
  DFFR_X1 REG_3_Q_reg_0_ ( .D(b3[0]), .CK(REG_3_net167), .RN(RST_n), .Q(bi[63]) );
  DFFR_X1 REG_3_Q_reg_1_ ( .D(b3[1]), .CK(REG_3_net167), .RN(RST_n), .Q(bi[64]) );
  DFFR_X1 REG_3_Q_reg_2_ ( .D(b3[2]), .CK(REG_3_net167), .RN(RST_n), .Q(bi[65]) );
  DFFR_X1 REG_3_Q_reg_3_ ( .D(b3[3]), .CK(REG_3_net167), .RN(RST_n), .Q(bi[66]) );
  DFFR_X1 REG_3_Q_reg_4_ ( .D(b3[4]), .CK(REG_3_net167), .RN(RST_n), .Q(bi[67]) );
  DFFR_X1 REG_3_Q_reg_5_ ( .D(b3[5]), .CK(REG_3_net167), .RN(RST_n), .Q(bi[68]) );
  DFFR_X1 REG_3_Q_reg_6_ ( .D(b3[6]), .CK(REG_3_net167), .RN(RST_n), .Q(bi[69]) );
  DFFR_X1 REG_3_Q_reg_7_ ( .D(b3[7]), .CK(REG_3_net167), .RN(RST_n), .Q(bi[70]) );
  DFFR_X1 REG_3_Q_reg_8_ ( .D(b3[8]), .CK(REG_3_net167), .RN(RST_n), .Q(bi[71]) );
  SNPS_CLOCK_GATE_HIGH_regn_s_N9_18 REG_4_clk_gate_Q_reg ( .CLK(clk), .EN(1'b1), .ENCLK(REG_4_net167), .TE(1'b0) );
  DFFR_X1 REG_4_Q_reg_0_ ( .D(b4[0]), .CK(REG_4_net167), .RN(RST_n), .Q(bi[54]) );
  DFFR_X1 REG_4_Q_reg_1_ ( .D(b4[1]), .CK(REG_4_net167), .RN(RST_n), .Q(bi[55]) );
  DFFR_X1 REG_4_Q_reg_2_ ( .D(b4[2]), .CK(REG_4_net167), .RN(RST_n), .Q(bi[56]) );
  DFFR_X1 REG_4_Q_reg_3_ ( .D(b4[3]), .CK(REG_4_net167), .RN(RST_n), .Q(bi[57]) );
  DFFR_X1 REG_4_Q_reg_4_ ( .D(b4[4]), .CK(REG_4_net167), .RN(RST_n), .Q(bi[58]) );
  DFFR_X1 REG_4_Q_reg_5_ ( .D(b4[5]), .CK(REG_4_net167), .RN(RST_n), .Q(bi[59]) );
  DFFR_X1 REG_4_Q_reg_6_ ( .D(b4[6]), .CK(REG_4_net167), .RN(RST_n), .Q(bi[60]) );
  DFFR_X1 REG_4_Q_reg_7_ ( .D(b4[7]), .CK(REG_4_net167), .RN(RST_n), .Q(bi[61]) );
  DFFR_X1 REG_4_Q_reg_8_ ( .D(b4[8]), .CK(REG_4_net167), .RN(RST_n), .Q(bi[62]) );
  SNPS_CLOCK_GATE_HIGH_regn_s_N9_17 REG_5_clk_gate_Q_reg ( .CLK(clk), .EN(1'b1), .ENCLK(REG_5_net167), .TE(1'b0) );
  DFFR_X1 REG_5_Q_reg_0_ ( .D(b5[0]), .CK(REG_5_net167), .RN(RST_n), .Q(bi[45]) );
  DFFR_X1 REG_5_Q_reg_1_ ( .D(b5[1]), .CK(REG_5_net167), .RN(RST_n), .Q(bi[46]) );
  DFFR_X1 REG_5_Q_reg_2_ ( .D(b5[2]), .CK(REG_5_net167), .RN(RST_n), .Q(bi[47]) );
  DFFR_X1 REG_5_Q_reg_3_ ( .D(b5[3]), .CK(REG_5_net167), .RN(RST_n), .Q(bi[48]) );
  DFFR_X1 REG_5_Q_reg_4_ ( .D(b5[4]), .CK(REG_5_net167), .RN(RST_n), .Q(bi[49]) );
  DFFR_X1 REG_5_Q_reg_5_ ( .D(b5[5]), .CK(REG_5_net167), .RN(RST_n), .Q(bi[50]) );
  DFFR_X1 REG_5_Q_reg_6_ ( .D(b5[6]), .CK(REG_5_net167), .RN(RST_n), .Q(bi[51]) );
  DFFR_X1 REG_5_Q_reg_7_ ( .D(b5[7]), .CK(REG_5_net167), .RN(RST_n), .Q(bi[52]) );
  DFFR_X1 REG_5_Q_reg_8_ ( .D(b5[8]), .CK(REG_5_net167), .RN(RST_n), .Q(bi[53]) );
  SNPS_CLOCK_GATE_HIGH_regn_s_N9_16 REG_6_clk_gate_Q_reg ( .CLK(clk), .EN(1'b1), .ENCLK(REG_6_net167), .TE(1'b0) );
  DFFR_X1 REG_6_Q_reg_0_ ( .D(b6[0]), .CK(REG_6_net167), .RN(RST_n), .Q(bi[36]) );
  DFFR_X1 REG_6_Q_reg_1_ ( .D(b6[1]), .CK(REG_6_net167), .RN(RST_n), .Q(bi[37]) );
  DFFR_X1 REG_6_Q_reg_2_ ( .D(b6[2]), .CK(REG_6_net167), .RN(RST_n), .Q(bi[38]) );
  DFFR_X1 REG_6_Q_reg_3_ ( .D(b6[3]), .CK(REG_6_net167), .RN(RST_n), .Q(bi[39]) );
  DFFR_X1 REG_6_Q_reg_4_ ( .D(b6[4]), .CK(REG_6_net167), .RN(RST_n), .Q(bi[40]) );
  DFFR_X1 REG_6_Q_reg_5_ ( .D(b6[5]), .CK(REG_6_net167), .RN(RST_n), .Q(bi[41]) );
  DFFR_X1 REG_6_Q_reg_6_ ( .D(b6[6]), .CK(REG_6_net167), .RN(RST_n), .Q(bi[42]) );
  DFFR_X1 REG_6_Q_reg_7_ ( .D(b6[7]), .CK(REG_6_net167), .RN(RST_n), .Q(bi[43]) );
  DFFR_X1 REG_6_Q_reg_8_ ( .D(b6[8]), .CK(REG_6_net167), .RN(RST_n), .Q(bi[44]) );
  SNPS_CLOCK_GATE_HIGH_regn_s_N9_15 REG_7_clk_gate_Q_reg ( .CLK(clk), .EN(1'b1), .ENCLK(REG_7_net167), .TE(1'b0) );
  DFFR_X1 REG_7_Q_reg_0_ ( .D(b7[0]), .CK(REG_7_net167), .RN(RST_n), .Q(bi[27]) );
  DFFR_X1 REG_7_Q_reg_1_ ( .D(b7[1]), .CK(REG_7_net167), .RN(RST_n), .Q(bi[28]) );
  DFFR_X1 REG_7_Q_reg_2_ ( .D(b7[2]), .CK(REG_7_net167), .RN(RST_n), .Q(bi[29]) );
  DFFR_X1 REG_7_Q_reg_3_ ( .D(b7[3]), .CK(REG_7_net167), .RN(RST_n), .Q(bi[30]) );
  DFFR_X1 REG_7_Q_reg_4_ ( .D(b7[4]), .CK(REG_7_net167), .RN(RST_n), .Q(bi[31]) );
  DFFR_X1 REG_7_Q_reg_5_ ( .D(b7[5]), .CK(REG_7_net167), .RN(RST_n), .Q(bi[32]) );
  DFFR_X1 REG_7_Q_reg_6_ ( .D(b7[6]), .CK(REG_7_net167), .RN(RST_n), .Q(bi[33]) );
  DFFR_X1 REG_7_Q_reg_7_ ( .D(b7[7]), .CK(REG_7_net167), .RN(RST_n), .Q(bi[34]) );
  DFFR_X1 REG_7_Q_reg_8_ ( .D(b7[8]), .CK(REG_7_net167), .RN(RST_n), .Q(bi[35]) );
  SNPS_CLOCK_GATE_HIGH_regn_s_N9_14 REG_8_clk_gate_Q_reg ( .CLK(clk), .EN(1'b1), .ENCLK(REG_8_net167), .TE(1'b0) );
  DFFR_X1 REG_8_Q_reg_0_ ( .D(b8[0]), .CK(REG_8_net167), .RN(RST_n), .Q(bi[18]) );
  DFFR_X1 REG_8_Q_reg_1_ ( .D(b8[1]), .CK(REG_8_net167), .RN(RST_n), .Q(bi[19]) );
  DFFR_X1 REG_8_Q_reg_2_ ( .D(b8[2]), .CK(REG_8_net167), .RN(RST_n), .Q(bi[20]) );
  DFFR_X1 REG_8_Q_reg_3_ ( .D(b8[3]), .CK(REG_8_net167), .RN(RST_n), .Q(bi[21]) );
  DFFR_X1 REG_8_Q_reg_4_ ( .D(b8[4]), .CK(REG_8_net167), .RN(RST_n), .Q(bi[22]) );
  DFFR_X1 REG_8_Q_reg_5_ ( .D(b8[5]), .CK(REG_8_net167), .RN(RST_n), .Q(bi[23]) );
  DFFR_X1 REG_8_Q_reg_6_ ( .D(b8[6]), .CK(REG_8_net167), .RN(RST_n), .Q(bi[24]) );
  DFFR_X1 REG_8_Q_reg_7_ ( .D(b8[7]), .CK(REG_8_net167), .RN(RST_n), .Q(bi[25]) );
  DFFR_X1 REG_8_Q_reg_8_ ( .D(b8[8]), .CK(REG_8_net167), .RN(RST_n), .Q(bi[26]) );
  SNPS_CLOCK_GATE_HIGH_regn_s_N9_13 REG_9_clk_gate_Q_reg ( .CLK(clk), .EN(1'b1), .ENCLK(REG_9_net167), .TE(1'b0) );
  DFFR_X1 REG_9_Q_reg_0_ ( .D(b9[0]), .CK(REG_9_net167), .RN(RST_n), .Q(bi[9])
         );
  DFFR_X1 REG_9_Q_reg_1_ ( .D(b9[1]), .CK(REG_9_net167), .RN(RST_n), .Q(bi[10]) );
  DFFR_X1 REG_9_Q_reg_2_ ( .D(b9[2]), .CK(REG_9_net167), .RN(RST_n), .Q(bi[11]) );
  DFFR_X1 REG_9_Q_reg_3_ ( .D(b9[3]), .CK(REG_9_net167), .RN(RST_n), .Q(bi[12]) );
  DFFR_X1 REG_9_Q_reg_4_ ( .D(b9[4]), .CK(REG_9_net167), .RN(RST_n), .Q(bi[13]) );
  DFFR_X1 REG_9_Q_reg_5_ ( .D(b9[5]), .CK(REG_9_net167), .RN(RST_n), .Q(bi[14]) );
  DFFR_X1 REG_9_Q_reg_6_ ( .D(b9[6]), .CK(REG_9_net167), .RN(RST_n), .Q(bi[15]) );
  DFFR_X1 REG_9_Q_reg_7_ ( .D(b9[7]), .CK(REG_9_net167), .RN(RST_n), .Q(bi[16]) );
  DFFR_X1 REG_9_Q_reg_8_ ( .D(b9[8]), .CK(REG_9_net167), .RN(RST_n), .Q(bi[17]) );
  SNPS_CLOCK_GATE_HIGH_regn_s_N9_12 REG_10_clk_gate_Q_reg ( .CLK(clk), .EN(
        1'b1), .ENCLK(REG_10_net167), .TE(1'b0) );
  DFFR_X1 REG_10_Q_reg_0_ ( .D(b10[0]), .CK(REG_10_net167), .RN(RST_n), .Q(
        bi[0]) );
  DFFR_X1 REG_10_Q_reg_1_ ( .D(b10[1]), .CK(REG_10_net167), .RN(RST_n), .Q(
        bi[1]) );
  DFFR_X1 REG_10_Q_reg_2_ ( .D(b10[2]), .CK(REG_10_net167), .RN(RST_n), .Q(
        bi[2]) );
  DFFR_X1 REG_10_Q_reg_3_ ( .D(b10[3]), .CK(REG_10_net167), .RN(RST_n), .Q(
        bi[3]) );
  DFFR_X1 REG_10_Q_reg_4_ ( .D(b10[4]), .CK(REG_10_net167), .RN(RST_n), .Q(
        bi[4]) );
  DFFR_X1 REG_10_Q_reg_5_ ( .D(b10[5]), .CK(REG_10_net167), .RN(RST_n), .Q(
        bi[5]) );
  DFFR_X1 REG_10_Q_reg_6_ ( .D(b10[6]), .CK(REG_10_net167), .RN(RST_n), .Q(
        bi[6]) );
  DFFR_X1 REG_10_Q_reg_7_ ( .D(b10[7]), .CK(REG_10_net167), .RN(RST_n), .Q(
        bi[7]) );
  DFFR_X1 REG_10_Q_reg_8_ ( .D(b10[8]), .CK(REG_10_net167), .RN(RST_n), .Q(
        bi[8]) );
  SNPS_CLOCK_GATE_HIGH_regn_s_N9_11 REG_0_0_clk_gate_Q_reg ( .CLK(clk), .EN(
        v_o), .ENCLK(REG_0_0_net167), .TE(1'b0) );
  DFFR_X1 REG_0_0_Q_reg_0_ ( .D(x[90]), .CK(REG_0_0_net167), .RN(RST_n), .Q(
        x[81]) );
  DFFR_X1 REG_0_0_Q_reg_1_ ( .D(x[91]), .CK(REG_0_0_net167), .RN(RST_n), .Q(
        x[82]) );
  DFFR_X1 REG_0_0_Q_reg_2_ ( .D(x[92]), .CK(REG_0_0_net167), .RN(RST_n), .Q(
        x[83]) );
  DFFR_X1 REG_0_0_Q_reg_3_ ( .D(x[93]), .CK(REG_0_0_net167), .RN(RST_n), .Q(
        x[84]) );
  DFFR_X1 REG_0_0_Q_reg_4_ ( .D(x[94]), .CK(REG_0_0_net167), .RN(RST_n), .Q(
        x[85]) );
  DFFR_X1 REG_0_0_Q_reg_5_ ( .D(x[95]), .CK(REG_0_0_net167), .RN(RST_n), .Q(
        x[86]) );
  DFFR_X1 REG_0_0_Q_reg_6_ ( .D(x[96]), .CK(REG_0_0_net167), .RN(RST_n), .Q(
        x[87]) );
  DFFR_X1 REG_0_0_Q_reg_7_ ( .D(x[97]), .CK(REG_0_0_net167), .RN(RST_n), .Q(
        x[88]) );
  DFFR_X1 REG_0_0_Q_reg_8_ ( .D(x[98]), .CK(REG_0_0_net167), .RN(RST_n), .Q(
        x[89]) );
  SNPS_CLOCK_GATE_HIGH_regn_s_N9_10 REG_1_0_clk_gate_Q_reg ( .CLK(clk), .EN(
        v_o), .ENCLK(REG_1_0_net167), .TE(1'b0) );
  DFFR_X1 REG_1_0_Q_reg_0_ ( .D(x[81]), .CK(REG_1_0_net167), .RN(RST_n), .Q(
        x[72]) );
  DFFR_X1 REG_1_0_Q_reg_1_ ( .D(x[82]), .CK(REG_1_0_net167), .RN(RST_n), .Q(
        x[73]) );
  DFFR_X1 REG_1_0_Q_reg_2_ ( .D(x[83]), .CK(REG_1_0_net167), .RN(RST_n), .Q(
        x[74]) );
  DFFR_X1 REG_1_0_Q_reg_3_ ( .D(x[84]), .CK(REG_1_0_net167), .RN(RST_n), .Q(
        x[75]) );
  DFFR_X1 REG_1_0_Q_reg_4_ ( .D(x[85]), .CK(REG_1_0_net167), .RN(RST_n), .Q(
        x[76]) );
  DFFR_X1 REG_1_0_Q_reg_5_ ( .D(x[86]), .CK(REG_1_0_net167), .RN(RST_n), .Q(
        x[77]) );
  DFFR_X1 REG_1_0_Q_reg_6_ ( .D(x[87]), .CK(REG_1_0_net167), .RN(RST_n), .Q(
        x[78]) );
  DFFR_X1 REG_1_0_Q_reg_7_ ( .D(x[88]), .CK(REG_1_0_net167), .RN(RST_n), .Q(
        x[79]) );
  DFFR_X1 REG_1_0_Q_reg_8_ ( .D(x[89]), .CK(REG_1_0_net167), .RN(RST_n), .Q(
        x[80]) );
  SNPS_CLOCK_GATE_HIGH_regn_s_N9_9 REG_2_0_clk_gate_Q_reg ( .CLK(clk), .EN(v_o), .ENCLK(REG_2_0_net167), .TE(1'b0) );
  DFFR_X1 REG_2_0_Q_reg_0_ ( .D(x[72]), .CK(REG_2_0_net167), .RN(RST_n), .Q(
        x[63]) );
  DFFR_X1 REG_2_0_Q_reg_1_ ( .D(x[73]), .CK(REG_2_0_net167), .RN(RST_n), .Q(
        x[64]) );
  DFFR_X1 REG_2_0_Q_reg_2_ ( .D(x[74]), .CK(REG_2_0_net167), .RN(RST_n), .Q(
        x[65]) );
  DFFR_X1 REG_2_0_Q_reg_3_ ( .D(x[75]), .CK(REG_2_0_net167), .RN(RST_n), .Q(
        x[66]) );
  DFFR_X1 REG_2_0_Q_reg_4_ ( .D(x[76]), .CK(REG_2_0_net167), .RN(RST_n), .Q(
        x[67]) );
  DFFR_X1 REG_2_0_Q_reg_5_ ( .D(x[77]), .CK(REG_2_0_net167), .RN(RST_n), .Q(
        x[68]) );
  DFFR_X1 REG_2_0_Q_reg_6_ ( .D(x[78]), .CK(REG_2_0_net167), .RN(RST_n), .Q(
        x[69]) );
  DFFR_X1 REG_2_0_Q_reg_7_ ( .D(x[79]), .CK(REG_2_0_net167), .RN(RST_n), .Q(
        x[70]) );
  DFFR_X1 REG_2_0_Q_reg_8_ ( .D(x[80]), .CK(REG_2_0_net167), .RN(RST_n), .Q(
        x[71]) );
  SNPS_CLOCK_GATE_HIGH_regn_s_N9_8 REG_3_0_clk_gate_Q_reg ( .CLK(clk), .EN(v_o), .ENCLK(REG_3_0_net167), .TE(1'b0) );
  DFFR_X1 REG_3_0_Q_reg_0_ ( .D(x[63]), .CK(REG_3_0_net167), .RN(RST_n), .Q(
        x[54]) );
  DFFR_X1 REG_3_0_Q_reg_1_ ( .D(x[64]), .CK(REG_3_0_net167), .RN(RST_n), .Q(
        x[55]) );
  DFFR_X1 REG_3_0_Q_reg_2_ ( .D(x[65]), .CK(REG_3_0_net167), .RN(RST_n), .Q(
        x[56]) );
  DFFR_X1 REG_3_0_Q_reg_3_ ( .D(x[66]), .CK(REG_3_0_net167), .RN(RST_n), .Q(
        x[57]) );
  DFFR_X1 REG_3_0_Q_reg_4_ ( .D(x[67]), .CK(REG_3_0_net167), .RN(RST_n), .Q(
        x[58]) );
  DFFR_X1 REG_3_0_Q_reg_5_ ( .D(x[68]), .CK(REG_3_0_net167), .RN(RST_n), .Q(
        x[59]) );
  DFFR_X1 REG_3_0_Q_reg_6_ ( .D(x[69]), .CK(REG_3_0_net167), .RN(RST_n), .Q(
        x[60]) );
  DFFR_X1 REG_3_0_Q_reg_7_ ( .D(x[70]), .CK(REG_3_0_net167), .RN(RST_n), .Q(
        x[61]) );
  DFFR_X1 REG_3_0_Q_reg_8_ ( .D(x[71]), .CK(REG_3_0_net167), .RN(RST_n), .Q(
        x[62]) );
  SNPS_CLOCK_GATE_HIGH_regn_s_N9_7 REG_4_0_clk_gate_Q_reg ( .CLK(clk), .EN(v_o), .ENCLK(REG_4_0_net167), .TE(1'b0) );
  DFFR_X1 REG_4_0_Q_reg_0_ ( .D(x[54]), .CK(REG_4_0_net167), .RN(RST_n), .Q(
        x[45]) );
  DFFR_X1 REG_4_0_Q_reg_1_ ( .D(x[55]), .CK(REG_4_0_net167), .RN(RST_n), .Q(
        x[46]) );
  DFFR_X1 REG_4_0_Q_reg_2_ ( .D(x[56]), .CK(REG_4_0_net167), .RN(RST_n), .Q(
        x[47]) );
  DFFR_X1 REG_4_0_Q_reg_3_ ( .D(x[57]), .CK(REG_4_0_net167), .RN(RST_n), .Q(
        x[48]) );
  DFFR_X1 REG_4_0_Q_reg_4_ ( .D(x[58]), .CK(REG_4_0_net167), .RN(RST_n), .Q(
        x[49]) );
  DFFR_X1 REG_4_0_Q_reg_5_ ( .D(x[59]), .CK(REG_4_0_net167), .RN(RST_n), .Q(
        x[50]) );
  DFFR_X1 REG_4_0_Q_reg_6_ ( .D(x[60]), .CK(REG_4_0_net167), .RN(RST_n), .Q(
        x[51]) );
  DFFR_X1 REG_4_0_Q_reg_7_ ( .D(x[61]), .CK(REG_4_0_net167), .RN(RST_n), .Q(
        x[52]) );
  DFFR_X1 REG_4_0_Q_reg_8_ ( .D(x[62]), .CK(REG_4_0_net167), .RN(RST_n), .Q(
        x[53]) );
  SNPS_CLOCK_GATE_HIGH_regn_s_N9_6 REG_5_0_clk_gate_Q_reg ( .CLK(clk), .EN(v_o), .ENCLK(REG_5_0_net167), .TE(1'b0) );
  DFFR_X1 REG_5_0_Q_reg_0_ ( .D(x[45]), .CK(REG_5_0_net167), .RN(RST_n), .Q(
        x[36]) );
  DFFR_X1 REG_5_0_Q_reg_1_ ( .D(x[46]), .CK(REG_5_0_net167), .RN(RST_n), .Q(
        x[37]) );
  DFFR_X1 REG_5_0_Q_reg_2_ ( .D(x[47]), .CK(REG_5_0_net167), .RN(RST_n), .Q(
        x[38]) );
  DFFR_X1 REG_5_0_Q_reg_3_ ( .D(x[48]), .CK(REG_5_0_net167), .RN(RST_n), .Q(
        x[39]) );
  DFFR_X1 REG_5_0_Q_reg_4_ ( .D(x[49]), .CK(REG_5_0_net167), .RN(RST_n), .Q(
        x[40]) );
  DFFR_X1 REG_5_0_Q_reg_5_ ( .D(x[50]), .CK(REG_5_0_net167), .RN(RST_n), .Q(
        x[41]) );
  DFFR_X1 REG_5_0_Q_reg_6_ ( .D(x[51]), .CK(REG_5_0_net167), .RN(RST_n), .Q(
        x[42]) );
  DFFR_X1 REG_5_0_Q_reg_7_ ( .D(x[52]), .CK(REG_5_0_net167), .RN(RST_n), .Q(
        x[43]) );
  DFFR_X1 REG_5_0_Q_reg_8_ ( .D(x[53]), .CK(REG_5_0_net167), .RN(RST_n), .Q(
        x[44]) );
  SNPS_CLOCK_GATE_HIGH_regn_s_N9_5 REG_6_0_clk_gate_Q_reg ( .CLK(clk), .EN(v_o), .ENCLK(REG_6_0_net167), .TE(1'b0) );
  DFFR_X1 REG_6_0_Q_reg_0_ ( .D(x[36]), .CK(REG_6_0_net167), .RN(RST_n), .Q(
        x[27]) );
  DFFR_X1 REG_6_0_Q_reg_1_ ( .D(x[37]), .CK(REG_6_0_net167), .RN(RST_n), .Q(
        x[28]) );
  DFFR_X1 REG_6_0_Q_reg_2_ ( .D(x[38]), .CK(REG_6_0_net167), .RN(RST_n), .Q(
        x[29]) );
  DFFR_X1 REG_6_0_Q_reg_3_ ( .D(x[39]), .CK(REG_6_0_net167), .RN(RST_n), .Q(
        x[30]) );
  DFFR_X1 REG_6_0_Q_reg_4_ ( .D(x[40]), .CK(REG_6_0_net167), .RN(RST_n), .Q(
        x[31]) );
  DFFR_X1 REG_6_0_Q_reg_5_ ( .D(x[41]), .CK(REG_6_0_net167), .RN(RST_n), .Q(
        x[32]) );
  DFFR_X1 REG_6_0_Q_reg_6_ ( .D(x[42]), .CK(REG_6_0_net167), .RN(RST_n), .Q(
        x[33]) );
  DFFR_X1 REG_6_0_Q_reg_7_ ( .D(x[43]), .CK(REG_6_0_net167), .RN(RST_n), .Q(
        x[34]) );
  DFFR_X1 REG_6_0_Q_reg_8_ ( .D(x[44]), .CK(REG_6_0_net167), .RN(RST_n), .Q(
        x[35]) );
  SNPS_CLOCK_GATE_HIGH_regn_s_N9_4 REG_7_0_clk_gate_Q_reg ( .CLK(clk), .EN(v_o), .ENCLK(REG_7_0_net167), .TE(1'b0) );
  DFFR_X1 REG_7_0_Q_reg_0_ ( .D(x[27]), .CK(REG_7_0_net167), .RN(RST_n), .Q(
        x[18]) );
  DFFR_X1 REG_7_0_Q_reg_1_ ( .D(x[28]), .CK(REG_7_0_net167), .RN(RST_n), .Q(
        x[19]) );
  DFFR_X1 REG_7_0_Q_reg_2_ ( .D(x[29]), .CK(REG_7_0_net167), .RN(RST_n), .Q(
        x[20]) );
  DFFR_X1 REG_7_0_Q_reg_3_ ( .D(x[30]), .CK(REG_7_0_net167), .RN(RST_n), .Q(
        x[21]) );
  DFFR_X1 REG_7_0_Q_reg_4_ ( .D(x[31]), .CK(REG_7_0_net167), .RN(RST_n), .Q(
        x[22]) );
  DFFR_X1 REG_7_0_Q_reg_5_ ( .D(x[32]), .CK(REG_7_0_net167), .RN(RST_n), .Q(
        x[23]) );
  DFFR_X1 REG_7_0_Q_reg_6_ ( .D(x[33]), .CK(REG_7_0_net167), .RN(RST_n), .Q(
        x[24]) );
  DFFR_X1 REG_7_0_Q_reg_7_ ( .D(x[34]), .CK(REG_7_0_net167), .RN(RST_n), .Q(
        x[25]) );
  DFFR_X1 REG_7_0_Q_reg_8_ ( .D(x[35]), .CK(REG_7_0_net167), .RN(RST_n), .Q(
        x[26]) );
  SNPS_CLOCK_GATE_HIGH_regn_s_N9_3 REG_8_0_clk_gate_Q_reg ( .CLK(clk), .EN(v_o), .ENCLK(REG_8_0_net167), .TE(1'b0) );
  DFFR_X1 REG_8_0_Q_reg_0_ ( .D(x[18]), .CK(REG_8_0_net167), .RN(RST_n), .Q(
        x[9]) );
  DFFR_X1 REG_8_0_Q_reg_1_ ( .D(x[19]), .CK(REG_8_0_net167), .RN(RST_n), .Q(
        x[10]) );
  DFFR_X1 REG_8_0_Q_reg_2_ ( .D(x[20]), .CK(REG_8_0_net167), .RN(RST_n), .Q(
        x[11]) );
  DFFR_X1 REG_8_0_Q_reg_3_ ( .D(x[21]), .CK(REG_8_0_net167), .RN(RST_n), .Q(
        x[12]) );
  DFFR_X1 REG_8_0_Q_reg_4_ ( .D(x[22]), .CK(REG_8_0_net167), .RN(RST_n), .Q(
        x[13]) );
  DFFR_X1 REG_8_0_Q_reg_5_ ( .D(x[23]), .CK(REG_8_0_net167), .RN(RST_n), .Q(
        x[14]) );
  DFFR_X1 REG_8_0_Q_reg_6_ ( .D(x[24]), .CK(REG_8_0_net167), .RN(RST_n), .Q(
        x[15]) );
  DFFR_X1 REG_8_0_Q_reg_7_ ( .D(x[25]), .CK(REG_8_0_net167), .RN(RST_n), .Q(
        x[16]) );
  DFFR_X1 REG_8_0_Q_reg_8_ ( .D(x[26]), .CK(REG_8_0_net167), .RN(RST_n), .Q(
        x[17]) );
  SNPS_CLOCK_GATE_HIGH_regn_s_N9_2 REG_9_0_clk_gate_Q_reg ( .CLK(clk), .EN(v_o), .ENCLK(REG_9_0_net167), .TE(1'b0) );
  DFFR_X1 REG_9_0_Q_reg_0_ ( .D(x[9]), .CK(REG_9_0_net167), .RN(RST_n), .Q(
        x[0]) );
  DFFR_X1 REG_9_0_Q_reg_1_ ( .D(x[10]), .CK(REG_9_0_net167), .RN(RST_n), .Q(
        x[1]) );
  DFFR_X1 REG_9_0_Q_reg_2_ ( .D(x[11]), .CK(REG_9_0_net167), .RN(RST_n), .Q(
        x[2]) );
  DFFR_X1 REG_9_0_Q_reg_3_ ( .D(x[12]), .CK(REG_9_0_net167), .RN(RST_n), .Q(
        x[3]) );
  DFFR_X1 REG_9_0_Q_reg_4_ ( .D(x[13]), .CK(REG_9_0_net167), .RN(RST_n), .Q(
        x[4]) );
  DFFR_X1 REG_9_0_Q_reg_5_ ( .D(x[14]), .CK(REG_9_0_net167), .RN(RST_n), .Q(
        x[5]) );
  DFFR_X1 REG_9_0_Q_reg_6_ ( .D(x[15]), .CK(REG_9_0_net167), .RN(RST_n), .Q(
        x[6]) );
  DFFR_X1 REG_9_0_Q_reg_7_ ( .D(x[16]), .CK(REG_9_0_net167), .RN(RST_n), .Q(
        x[7]) );
  DFFR_X1 REG_9_0_Q_reg_8_ ( .D(x[17]), .CK(REG_9_0_net167), .RN(RST_n), .Q(
        x[8]) );
  SNPS_CLOCK_GATE_HIGH_regn_s_N9_1 DOUT_REG_clk_gate_Q_reg ( .CLK(clk), .EN(
        1'b1), .ENCLK(DOUT_REG_net167), .TE(1'b0) );
  DFFR_X1 DOUT_REG_Q_reg_0_ ( .D(z_10__0_), .CK(DOUT_REG_net167), .RN(RST_n), 
        .Q(DOUT[0]) );
  DFFR_X1 DOUT_REG_Q_reg_1_ ( .D(z_10__1_), .CK(DOUT_REG_net167), .RN(RST_n), 
        .Q(DOUT[1]) );
  DFFR_X1 DOUT_REG_Q_reg_2_ ( .D(z_10__2_), .CK(DOUT_REG_net167), .RN(RST_n), 
        .Q(DOUT[2]) );
  DFFR_X1 DOUT_REG_Q_reg_3_ ( .D(z_10__3_), .CK(DOUT_REG_net167), .RN(RST_n), 
        .Q(DOUT[3]) );
  DFFR_X1 DOUT_REG_Q_reg_4_ ( .D(z_10__4_), .CK(DOUT_REG_net167), .RN(RST_n), 
        .Q(DOUT[4]) );
  DFFR_X1 DOUT_REG_Q_reg_5_ ( .D(z_10__5_), .CK(DOUT_REG_net167), .RN(RST_n), 
        .Q(DOUT[5]) );
  DFFR_X1 DOUT_REG_Q_reg_6_ ( .D(z_10__6_), .CK(DOUT_REG_net167), .RN(RST_n), 
        .Q(DOUT[6]) );
  DFFR_X1 DOUT_REG_Q_reg_7_ ( .D(z_10__7_), .CK(DOUT_REG_net167), .RN(RST_n), 
        .Q(DOUT[7]) );
  DFFR_X1 DOUT_REG_Q_reg_8_ ( .D(z_10__8_), .CK(DOUT_REG_net167), .RN(RST_n), 
        .Q(DOUT[8]) );
  NAND2_X1 VOUT_REG_U3 ( .A1(v_o), .A2(1'b1), .ZN(VOUT_REG_n6) );
  ...
  INV_X1 mult_114_G2_U221 ( .A(mult_114_G2_n33), .ZN(mult_114_G2_n284) );
  INV_X1 mult_114_G2_U220 ( .A(mult_114_G2_n341), .ZN(mult_114_G2_n278) );
  ...
  INV_X1 mult_114_G9_U221 ( .A(mult_114_G9_n33), .ZN(mult_114_G9_n284) );
  INV_X1 mult_114_G9_U220 ( .A(mult_114_G9_n341), .ZN(mult_114_G9_n278) );
  ...
  INV_X1 mult_114_G3_U221 ( .A(mult_114_G3_n33), .ZN(mult_114_G3_n284) );
  INV_X1 mult_114_G3_U220 ( .A(mult_114_G3_n341), .ZN(mult_114_G3_n278) );
  ...
  INV_X1 mult_114_G4_U221 ( .A(mult_114_G4_n33), .ZN(mult_114_G4_n284) );
  INV_X1 mult_114_G4_U220 ( .A(mult_114_G4_n341), .ZN(mult_114_G4_n278) );
  ...
  INV_X1 mult_114_G10_U221 ( .A(mult_114_G10_n341), .ZN(mult_114_G10_n278) );
  INV_X1 mult_114_G10_U220 ( .A(mult_114_G10_n33), .ZN(mult_114_G10_n284) );
  ...
  INV_X1 mult_114_G5_U221 ( .A(mult_114_G5_n33), .ZN(mult_114_G5_n284) );
  INV_X1 mult_114_G5_U220 ( .A(mult_114_G5_n341), .ZN(mult_114_G5_n278) );
  ...
  INV_X1 mult_114_G6_U221 ( .A(mult_114_G6_n33), .ZN(mult_114_G6_n284) );
  INV_X1 mult_114_G6_U220 ( .A(mult_114_G6_n341), .ZN(mult_114_G6_n278) );
  ...
  INV_X1 mult_114_G8_U221 ( .A(mult_114_G8_n33), .ZN(mult_114_G8_n284) );
  INV_X1 mult_114_G8_U220 ( .A(mult_114_G8_n341), .ZN(mult_114_G8_n278) );
  ...
  XOR2_X1 add_0_root_add_0_root_add_122_G10_U2 ( .A(z_8__0_), .B(z_5__0_), .Z(
        z_10__0_) );
  AND2_X1 add_0_root_add_0_root_add_122_G10_U1 ( .A1(z_8__0_), .A2(z_5__0_), 
        .ZN(add_0_root_add_0_root_add_122_G10_n1) );
  FA_X1 add_0_root_add_0_root_add_122_G10_U1_1 ( .A(z_5__1_), .B(z_8__1_), 
        .CI(add_0_root_add_0_root_add_122_G10_n1), .CO(
